...
public class CreateDocx
{
    ...
    public MemoryStream GetDocxFile()
    {
        ...
        try
        {
            ...
            using (DataTable dt = xCar.Exec_Get_Existing_Car_By_Oid_Datatable())
            {
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    ///Row 28a
                    Table table28a = editor.InsertTable();
                    table28a.StyleId = BuiltInStyleNames.TableGridStyleId;

                    TableRow row28a = table28a.Rows.AddTableRow();
                    TableCell cell28a = row28a.Cells.AddTableCell();
                    Paragraph cellPar28a = cell28a.Blocks.AddParagraph();

                    Run runCellText28a = cellPar28a.Inlines.AddRun(string.Format("Responsible Person:", 0, 0));
                    runCellText28a.FontWeight = FontWeights.Bold;
                    runCellText28a.FontSize = fontSizeBody;
                    cell28a.PreferredWidth = new TableWidthUnit(cellWidth);

                    Table table28b = editor.InsertTable();
                    table28b.StyleId = BuiltInStyleNames.TableGridStyleId;

                    TableRow row28b = table28b.Rows.AddTableRow();

                    TableCell cell28b = row28b.Cells.AddTableCell();
                    Paragraph cellPar28b = cell28b.Blocks.AddParagraph();

                    Run runCellText28b = cellPar28b.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["RESP_PERSON_USR_NM"].ToString())))), 0, 1));
                    runCellText28b.ForegroundColor = BlueColor;
                    runCellText28b.FontSize = fontSizeBody;
                    cell28b.PreferredWidth = new TableWidthUnit(cellWidth2);
                    ...
                    Run runCellText54 = cellPar54.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["NON_CONFORM_RSN"].ToString())))), 0, 0));
                    ...
                    Run runCellText56 = cellPar56.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["ROOT_CAUSE"].ToString())))), 0, 0));
                    ...
                    Run runCellText58 = cellPar58.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["SIMILAR_INSTANCE_Y_N_TEXT"].ToString())))), 0, 0));
                    ...
                    Run runCellText58b = cellPar58b.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["SIMILAR_INSTANCE"].ToString())))), 0, 0));
                    ...
                    Run runCellText60 = cellPar60.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["CORR_ACTION_TAKEN"].ToString())))), 0, 0));
                    ...
                    Run runCellText62 = cellPar62.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["CORR_ACTION_TAKEN_DT"].ToString())))), 0, 0));
                    ...
                    Run runCellText64 = cellPar64.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["PRECLUDE_ACTION"].ToString())))), 0, 0));
                    ...
                    Run runCellText66 = cellPar66.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["PRECLUDE_ACTION_DT"].ToString())))), 0, 0));
                    ...
                    Run runCellText68 = cellPar68.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["ACTION_TAKEN_BY_USR_NM"].ToString())))), 0, 1));
                    ...
                    Run runCellText70 = cellPar70.Inlines.AddRun(string.Format(removeChar.SanitizeField(removeChar.SanitizeQuoteString(htmlUtil.SanitizeHtml(HttpUtility.HtmlDecode(row["RESPONSE_DT"].ToString())))), 0, 1));
    ...
    private void LogException(Exception ex)
    {
        ...
        appLog.ExceptionSource = "External_Class_CreateDocx.cs";
