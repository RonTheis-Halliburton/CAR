...
public class CreateNewPdf
{
    ...
    public MemoryStream GetNewPdfFile()
    {
        ...
        try
        {
            ...
            using (DataTable dt = xCar.Exec_Get_Existing_Car_By_Oid_Datatable())
            {
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    tableQ1.SpacingAfter = SpacingAfter;
                    ...
                    tableQ2.SpacingAfter = SpacingAfter;
                    ...
                    tableQ3.SpacingAfter = SpacingAfter;
                    ...
                    colA3.Border = 0;
                    colA3.Phrase = new Phrase(" ", font10);
                    ...
                    tableQ4.SpacingAfter = SpacingAfter;
                    ...
                    tableQ4D.SpacingAfter = SpacingAfter;
                    ...
                    tableQ5.SpacingAfter = SpacingAfter;
                    ...
                    tableQ5D.SpacingAfter = SpacingAfter;
                    ...
                    //tableOrig.SpacingAfter = SpacingAfter;
    ...
    private void LogException(Exception ex)
    {
        ...
        appLog.ExceptionSource = "External_Class_CreateNewPdf.cs";
