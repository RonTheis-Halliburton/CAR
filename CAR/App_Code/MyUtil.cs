...
namespace CAR
{
    public class MyUtil
    {
        ...
        {"ins", new string[]        {"style", "class"}}        };
            ...
            {
                DateTime dt;
                return DateTime.TryParse(obj, out dt);
            ...
            public string FileSizeByte(long n)
            {
                string retVal = string.Empty;

                if (n <= 1024)
                {
                    retVal = n.ToString() + " BYTES";
                }
                else if (n > 1024 && n <= 1048576)
                {
                    retVal = (n / 1024).ToString() + " KB";
                }
                else if (n > 1048576 && n <= 1073741824)
                {
                    retVal = (n / 1048576).ToString() + " MB";
                }
                else if (n > 1073741824 && n <= 109951162777)
                {
                    retVal = (n / 1073741824).ToString() + " GB";
                }
                else
                {
                    retVal = (n / 109951162777).ToString() + " TB";
                }
