<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="CAR.Forms.Search" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
        <script type="text/javascript">
            ...
            function ShowMenu(evt, oid, rowIndex) {
                ...
                var reIssuedToUsrId = masterTable.getCellByColumnUniqueName(masterTable.get_dataItems()[rowIndex], "REISSUED_TO_USR_ID").innerHTML;
                var actionTakenByUsrId = masterTable.getCellByColumnUniqueName(masterTable.get_dataItems()[rowIndex], "ACTION_TAKEN_BY_USR_ID").innerHTML;
                var respPersonUsrId = masterTable.getCellByColumnUniqueName(masterTable.get_dataItems()[rowIndex], "RESP_PERSON_USR_ID").innerHTML;
                ...
                if (carAdmin == "True") {
                    ...
                    if (statusOid == 3 && qdmsIndexed == 0) { //Closed and not yet indexed to QDMS                      

                        if (originatorID == curUsrID || verifiedID == curUsrID || createBy == curUsrID) {
                            menu.get_items().getItem(3).set_visible(true); //Index QDMS
                            menu.get_items().getItem(7).set_visible(true); //Send Message
                            //menu.get_items().getItem(8).set_visible(true); //file upload
                        }
                        ...
                        if (originatorID == curUsrID || verifiedID == curUsrID || respPersonUsrId == curUsrID ||
                            originatorMgrID == curUsrID || createBy == curUsrID || issuedToUsrId == curUsrID || reIssuedToUsrId == curUsrID || actionTakenByUsrId == curUsrID) {
                            menu.get_items().getItem(2).set_visible(true); //edit
                            menu.get_items().getItem(7).set_visible(true); //Send Message
                            //menu.get_items().getItem(8).set_visible(true); //file upload
                        }
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" OnAjaxRequest="RadAjaxPanel1_AjaxRequest" Height="100%" LoadingPanelID="LoadingPanel1">
            <div class="contentContainer">
                <fieldset class="fieldset">
                    <legend style="font-family: Arial;">Search Corrective Action</legend>
                    <table>
                        <tr>
                            <td style="vertical-align: top; border-right-style: solid; border-right-width: 1px; border-right-color: lightgray; overflow: auto; height: auto;">
                                <table>
                                    <tr>
                                        <td style="text-align: center;">
                                            <telerik:RadButton ID="RadButton1" runat="server" Text="Search" RenderMode="Lightweight" BorderColor="Blue"
                                                SingleClick="true" SingleClickText="Searching..." Value="Search" CausesValidation="false" OnClick="RadButton1_Click" ButtonType="SkinnedButton" Width="200px">
                                    ...
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <telerik:RadTextBox ID="RadTextBox1" runat="server" Width="200px" EmptyMessage="Search Criteria..." MaxLength="150"></telerik:RadTextBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <telerik:RadListBox ID="RadListBox1" runat="server" Height="100px" Width="200px" SelectionMode="Multiple" Sort="Ascending" CheckBoxes="true"></telerik:RadListBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <telerik:RadComboBox ID="RadComboBox7" runat="server" MarkFirstMatch="True" Width="200px" DropDownWidth="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>Area</legend>
                                                <telerik:RadComboBox ID="RadComboBox6" runat="server" MarkFirstMatch="True" Width="200px" DropDownWidth="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <telerik:RadComboBox ID="RadComboBox1" runat="server" MarkFirstMatch="True" Width="200px" DropDownWidth="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>Plant</legend>
                                                <telerik:RadComboBox ID="RadComboBox2" runat="server" MarkFirstMatch="True" Width="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" DropDownAutoWidth="Enabled"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>PSL</legend>
                                                <telerik:RadComboBox ID="RadComboBox3" runat="server" MarkFirstMatch="True" Width="200px" DropDownWidth="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <telerik:RadComboBox ID="RadComboBox4" runat="server" MarkFirstMatch="True" Width="200px" DropDownWidth="200px" Height="150px" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>API or ISO</legend>
                                                <telerik:RadComboBox ID="RadComboBox5" runat="server" MarkFirstMatch="True" Width="200px" Height="200px" DropDownAutoWidth="Enabled" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" ExpandDirection="Up"></telerik:RadComboBox>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <telerik:RadComboBox ID="RadComboBox8" runat="server" Width="200px" DropDownWidth="200px" Height="150px" OnSelectedIndexChanged="RadComboBox8_SelectedIndexChanged"></telerik:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <telerik:RadDatePicker ID="RadDatePicker1" MinDate="2011-01-01" runat="server" PopupDirection="TopLeft" Width="200px">
                                                                <DateInput ID="DateInput2" runat="server" ForeColor="Black" Font-Names="Arial" EmptyMessage="From Date"
                                                                    ClientEvents-OnError="DateOnError">
                                                                </DateInput>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <telerik:RadDatePicker ID="RadDatePicker2" MinDate="2011-01-01" runat="server" PopupDirection="TopLeft" Width="200px">
                                                                <DateInput ID="DateInput4" runat="server" ForeColor="Black" Font-Names="Arial" EmptyMessage="To Date"
                                                                    ClientEvents-OnError="DateOnError">
                                                                </DateInput>
                                    ...
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>Deleted CAR</legend>
                                                <telerik:RadComboBox ID="RadComboBox9" runat="server" Width="200px" Height="100px" ExpandDirection="Up">
                                                    <Items>
                                    ...
                                    <tr>
                                        <td>
                                            <fieldset class="fieldset">
                                                <legend>Indexed to QDMS</legend>
                                                <telerik:RadComboBox ID="RadComboBox10" runat="server" Width="200px" Height="100px" ExpandDirection="Up">
                                                    <Items>
                                                        <telerik:RadComboBoxItem Text="ALL" Value="ALL" Selected="true" />
                                                        <telerik:RadComboBoxItem Text="No" Value="0" />
                                                        <telerik:RadComboBoxItem Text="Yes" Value="1" />
                            ...
                            <td style="vertical-align: top;">
                                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" ShowStatusBar="true" AllowPaging="True" PageSize="100"
                                    ...
                                    OnNeedDataSource="RadGrid1_NeedDataSource" OnItemCommand="RadGrid1_ItemCommand" OnItemDataBound="RadGrid1_ItemDataBound"
                                    ...
                                    <ClientSettings EnableRowHoverStyle="true">
                                        ...
                                        <ClientEvents OnGridCreated="GridCreated_ScrollHeight" />
                                    ...
                                    <MasterTableView DataKeyNames="OID, CAR_NBR" Width="100%" NoMasterRecordsText="No records to display." Name="TopLevel" EnableNoRecordsTemplate="true"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="RESP_PERSON_USR_ID" HeaderText="RESP_PERSON_USR_ID" SortExpression="RESP_PERSON_USR_ID" UniqueName="RESP_PERSON_USR_ID" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="ACTION_TAKEN_BY_USR_ID" HeaderText="ACTION_TAKEN_BY_USR_ID" SortExpression="ACTION_TAKEN_BY_USR_ID" UniqueName="ACTION_TAKEN_BY_USR_ID" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="REISSUED_TO_USR_ID" HeaderText="REISSUED_TO_USR_ID" SortExpression="REISSUED_TO_USR_ID" UniqueName="REISSUED_TO_USR_ID" Display="false">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="API_ISO_ELEM" HeaderText="API_ISO" SortExpression="API_ISO_ELEM" UniqueName="API_ISO_ELEM" Display="false">
                                            </telerik:GridBoundColumn>
